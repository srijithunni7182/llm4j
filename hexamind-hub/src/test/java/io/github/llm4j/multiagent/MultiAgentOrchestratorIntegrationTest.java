...
public class MultiAgentOrchestratorIntegrationTest {
    ...
    void setUp() {
        ...
        LLMResponse mockResponse = LLMResponse.builder()
                .content("This is a comprehensive consensus based on all agent inputs.")
                .build();
        ...
        List<AgentParticipant> agents = List.of(
                ...
                createMockAgent("business", "Business Consultant", PersonaLibrary.businessConsultant()));

        SimpMessagingTemplate messagingTemplate = mock(SimpMessagingTemplate.class);
        orchestrator = new MultiAgentOrchestrator(agents, messagingTemplate, mockLLMClient);
    }
