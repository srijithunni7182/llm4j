 ...
 * properly use tools through reasoning loops.
 *
 * <p>Note: Agent behavior is inherently probabilistic with LLMs. Tests focus on verifying the agent
...
class ReActAgentIntegrationTest {
    ...
    void testMultiStepReasoning() {
        ...
        AgentResult result =
                agent.run("If I have 20 apples and give away 8, how many do I have left?");
            ...
            if (step.getAction() != null) {
                ...
                System.out.println(
                        "Step: "
                                ...
                                + " → "
                                + step.getObservation()
                                        .substring(0, Math.min(30, step.getObservation().length()))
                                + "...");
            }
        }
