...
class RAGAgentTest {
    ...
    @Mock private ReActAgent mockAgent;
    @Mock private VectorStore mockVectorStore;
    ...
    void run_shouldRetrievalAndAugmentPrompt() {
        ...
        AgentResult expectedResult =
                AgentResult.builder().finalAnswer("The capital of France is Paris.").build();
    ...
    void run_shouldHandleEmptyRetrieval() {
        ...
        AgentResult expectedResult = AgentResult.builder().finalAnswer("I don't know.").build();
        when(mockAgent.run(question))
                .thenReturn(expectedResult); // Should pass original question if no context
    ...
    void addDocument_shouldChunkEmbedAndStore() {
        ...
        when(mockEmbeddingProvider.embedBatch(anyList()))
