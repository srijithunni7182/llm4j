...
/** Example demonstrating the ReAct Agent's ability to speak in different languages. */
public class MultilingualAgentExample {
    ...
    public static void main(String[] args) {
        ...
        ReActAgent malayalamAgent =
                ReActAgent.builder()
                        .llmClient(
                                new io.github.llm4j.DefaultLLMClient(
                                        new SarvamChatProvider(config)))
