...
class PIIEntityTest {
    ...
    void testIndexValidation_startLessThanEnd() {
        assertDoesNotThrow(() -> PIIEntity.builder()
                .type(PIIType.EMAIL)
                .value("test")
                .startIndex(0)
                .endIndex(4)
    ...
    void testIndexValidation_throwsIfInvalid() {
        assertThrows(IllegalArgumentException.class, () -> PIIEntity.builder()
                .type(PIIType.EMAIL)
                .value("test")
                .startIndex(5)
                .endIndex(2)
    ...
    void testEquals_sameValues() {
        PIIEntity entity1 = PIIEntity.builder()
                .type(PIIType.EMAIL)
                .value("test@example.com")
                .startIndex(0)
                .endIndex(16)
        ...
        PIIEntity entity2 = PIIEntity.builder()
                .type(PIIType.EMAIL)
                .value("test@example.com")
                .startIndex(0)
                .endIndex(16)
