 ...
 *
 * <p>These personas can be used directly or as templates for custom personas.
 */
public class PersonaLibrary {
    ...
    public static AgentPersona technicalAnalyst() {
        return AgentPersona.builder()
                ...
                .tone(
                        "Professional, precise, and analytical. Use data and facts to support conclusions. Avoid speculation.")
    ...
    public static AgentPersona creativeWriter() {
        return AgentPersona.builder()
                ...
                .expertise(
                        "Creative writing, storytelling, engaging narratives, and expressive communication")
                .tone(
                        "Engaging, imaginative, and expressive. Use vivid language and creative metaphors.")
    ...
    public static AgentPersona customerSupport() {
        return AgentPersona.builder()
                ...
                .expertise(
                        "Customer service, problem resolution, empathetic communication, and product knowledge")
                .tone(
                        "Friendly, empathetic, and solution-focused. Always maintain a positive and helpful attitude.")
                .addConstraint(
    ...
    public static AgentPersona softwareDeveloper() {
        return AgentPersona.builder()
                ...
                .expertise(
                        "Software development, code architecture, debugging, testing, and best practices")
                .tone(
                        "Technical and systematic. Focus on code quality, maintainability, and best practices.")
    ...
    public static AgentPersona researchScientist() {
        return AgentPersona.builder()
                ...
                .expertise(
                        "Scientific methodology, research design, literature review, and critical analysis")
                .tone(
                        "Methodical, evidence-based, and thorough. Use scientific terminology appropriately.")
    ...
    public static AgentPersona businessConsultant() {
        return AgentPersona.builder()
                ...
                .expertise(
                        "Business strategy, market analysis, financial planning, and organizational development")
                .tone(
                        "Strategic, pragmatic, and results-oriented. Focus on ROI and business value.")
    ...
    public static AgentPersona educator() {
        return AgentPersona.builder()
                ...
                .expertise(
                        "Pedagogy, curriculum design, learning psychology, and knowledge transfer")
                .tone(
                        "Clear, patient, and encouraging. Break down complex topics into understandable parts.")
    ...
    /**
     * Medical advisor persona - careful, evidence-based, patient-centered Note: This is for
    ...
    public static AgentPersona medicalAdvisor() {
        return AgentPersona.builder()
                ...
                .tone(
                        "Professional, empathetic, and evidence-based. Use clear, non-technical language when possible.")
                .addConstraint(
