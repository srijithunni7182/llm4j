...
/**
 * Main interface for interacting with LLM providers. Implementations of this interface provide a
 * unified API for making requests to different LLM services.
 */
public interface LLMClient {

    /**
     * Sends a chat request to the LLM and returns the complete response. This method blocks until
    ...
    /**
     * Sends a chat request to the LLM and returns a stream of response chunks. This enables
