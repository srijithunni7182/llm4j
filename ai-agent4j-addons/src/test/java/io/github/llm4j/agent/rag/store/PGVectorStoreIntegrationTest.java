...
class PGVectorStoreIntegrationTest {
    ...
    void testVectorOperations() {
        ...
        assertThat(results.get(0).getSimilarity()).isCloseTo(1.0f, org.assertj.core.data.Offset.offset(0.0001f));
    ...
    void testUpsert() {
        ...
        assertThat(vectorStore.size()).isEqualTo(1);
        List<VectorStore.SearchResult> results = vectorStore.search(new float[] { 0.9f, 0.9f, 0.9f }, 1);
        assertThat(results.get(0).getSimilarity()).isCloseTo(1.0f, org.assertj.core.data.Offset.offset(0.001f));
