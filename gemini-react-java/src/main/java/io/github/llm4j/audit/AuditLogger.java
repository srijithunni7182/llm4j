...
/**
 * Interface for audit logging to support xAI compliance.
 * Provides structured logging of agent decisions, tool executions, and prompt
 * usage.
 * 
...
public interface AuditLogger {
     ...
     */
    void logToolExecution(String sessionId, String toolName, String input, String output, Instant timestamp);
     ...
     */
    void logConversationEvent(String sessionId, String userId, String eventType, Map<String, Object> metadata);
}
